  ...
  return (
    <div className='md:px-8 lg:px-12'>
      ...
      <div className='mx-3 md:mx-0'>
        ...
        <p className='px-3 my-5 text-gray-600'>
          Xác định các quy tắc, quá trình và mục tiêu để bản thân tuân thủ.
          <br />
          Tất cả đóng vai trò như khuôn khổ cho cách m sống và giữ cho m tập trung, xử lý các chuyện trong cuộc sống một cách uyển chuyển và có hệ thống.
        </p>
        ...
        <section className='my-5'>
          ...
          <ol className='list-decimal pl-5 my-4'>
            <li className="mb-2">
              <p className="mb-2">
                Đặt nhiệm vụ và mục tiêu -&gt; Kế hoạch -&gt; Tập trung.
              </p>
              <p className='mb-2'>Tập trung vào các mục tiêu dài hạn và sắp sếp những ưu tiên hiện tại theo chúng.</p>
              <p className="mb-2">Quyết định những gì quan trọng với bản thân và tập trung vào nó, tập trung vào những thứ có thể kiểm soát, chỉ sử dụng vào những yếu tố, công cụ cần thiết.</p>
              <p className='mb-2'>Một nhiệm vụ tại một thời điểm, tránh bị phân tâm. Luôn chú ý đến hành động và suy nghĩ của mình. Ý thức về giá trị của thời gian.</p>
              <p className="mb-2">Đơn giản hoá và giảm thiếu mọi thứ. Loại bỏ ma sát. Lọc thông tin tiêu thụ để tối ưu hoá cho tín hiệu...</p>
              <p className="mb-2">Cố gắng và không thảo luận quá nhiều về những điều thực sự không ảnh hưởng đến cuộc sống của m theo bất kỳ cách nào.</p>
            </li>
            ...
            <li className="mb-2">
              Suy nghĩ từ những nguyên tắc đầu tiên (những điều căn bản). Học từ những thất bại. Phản chiếu (Reflect).
              <br />
              Thích nghi, nắm bắt thay đổi. Chủ động. Mạnh dạn và cỡi mở. Nắm quyền sở hữu.
              <br />
              Never complain, never give up.
            </li>
            <li className="mb-2">
              Porn, Game và Internet là những thứ tạo ra dopamine gây cho ta sự hưng phấn tạm thời,
              thay vì phải va chạm bên ngoài xã hội để đạt được mục tiêu và hưởng lượng dopamine đấy.
              <br />
              Tự cách ly xã hội là một hành vi ngu xuẩn, nó sẽ giết chết kỹ năng xã hội từ bên trong,
              nó sẽ dẫn tới các áp lực tiêu cực tới bản thân mày và người khác.
            </li>
            <li className="mb-2">
              Đừng so sánh bản thân mình với người khác. Đừng ám ảnh về bất cứ ai.
              <br />
              Học hỏi từ mọi người mà tôi ngưỡng mộ, thích. Sử dụng nó để cải thiện cuộc sống của tôi.
            </li>
            <li className="mb-2">
              <p className="mb-2">
                Luôn tìm cách hoàn thiện và thay đổi bản thân mình chứ không phải ai khác.
              </p>
              <p className='mb-2 italic'> “Cỏ không xanh hơn ở phía bên kia, nó xanh hơn ở nơi bạn tưới nó.</p>
              Đừng chăm chăm vào sự không hoàn hảo, hãy tìm kiếm vẻ đẹp trong mọi thứ.
            </li>
            <li className="mb-2">
              Bao quanh bản thân với những người truyền cảm hứng và có thể tin tưởng để làm điều tốt. <br />
              Hãy là con người thật của tôi. Truyền cảm hứng cho người khác.
            </li>
            <li className="mb-2">
              Đừng phán xét, ghét bỏ bất cứ ai. Cố gắng xem quan điểm của người khác. <br />
              Tử tế. Thể hiện tình yêu thương và sự đồng cảm. Không có bản ngã, cái tôi.
            </li>
            <li className="mb-2">
              Hãy tự tin vào suy nghĩ và hành động của mình. Tìm kiếm và đưa ra phản hồi thẳng thắn. Đáp lại một cách lịch sự.
            </li>
            ...
            <li className="mb-2">
              Hãy cảnh giác với thực tế là bất cứ ai cũng có thể nói dối (ở mọi phía), đặc biệt là khi nói về tin tức chính trị. <br />
              Sự thật thường phức tạp hơn. Đừng vội kết luận. Có ý kiến, suy nghĩ của riêng tôi.</li>
            <li className="mb-2">
              Bất cứ điều gì được thực hiện không đồng bộ là một hình thức tự động hoá, <br />
              bạn đang sao chép con người hiện tại của mình để sẵn sàng cho một nhiệm vụ trong tương lai mà không cần phải ở đó.
            </li>
        ...
        <section className='my-5'>
          ...
          <ul className='list-disc pl-5'>
            <li className='mb-2'>Kỷ luật không phải là ý chí, sức mạnh. Mà là loại bỏ sự phiền nhiễu xung quanh bản thân, những thứ khiến bản thân phân tâm.
              ...
              <span className='font-medium'>M làm việc khi không có gì tốt hơn để làm.</span>
            </li>
            ...
            <li className='mb-2'>Sử dụng nổ lực tối thiểu để có được một kết quả nhất định (đừng cố gắng thêm nữa và loại bỏ những căng thẳng không cần thiết)
              <p className='mb-1' >Cái giá phải trả cho chủ nghĩa hoàn hão: Dành thời gian để làm những thứ mà bạn không biết ai muốn.</p>
              <p className='mb-1'></p>
            </li>
            <li className='mb-2'>
            ...
            <li className='mb-2'>Khi một người không thể bắt đầu dự án mà họ quan tâm, điều đó thường là do:
              <p className='mb-2'>Lo lắng về việc nỗ lực của họ không đủ tốt.</p>
              <p className='mb-2'>Nhầm lầm về những bước đầu tiên của nhiệm vụ, không phải sự lười biếng.</p>
            </li>
