...
export default function Page() {
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className='flex flex-col flex-1 items-center no-list my-10 px-4'>
      ...
      <div className="flex flex-0 justify-center items-center bg-stone-100 h-16">
        <div className="flex flex-1 container-center items-center mx-8 font-bold text-stone-500 text-sm font-mono">
